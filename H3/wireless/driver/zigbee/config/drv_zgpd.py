...
################################### HEADER FILES ####################################################
    ...
    zgpAppIncFiles = [
        ...
        ['application/zigbee_only/Zigbee_ZgpSensor_Application/api/include/cs_api.h',         condAlways],
        ['application/zigbee_only/Zigbee_ZgpSensor_Application/api/include/zgb_api.h',         condAlways],
...
################################### Library File ####################################################
    ...
    setAdditionaloptionXC32GCC.setValue('-include"zigbee\zigbee_device\configs\zigbeeAppConfig.h"')
    ...
    setAdditionaloptionXC32GCC1.setValue('-include"zigbee/zigbee_device/configs/Mac2_CommonMac_StdzgpSec_Pic32cx_Rf233_Gcc_Makerules.h"')
...
def importIncFileNonStack(component, configName, incFileEntry, firmwarePath = None):
    ...
    secTname = secDName.replace('Zigbee_ZgpSensor_Application','zigbee_device')
...
def setIncPath(component, configName, incPathEntry):
    ...
    incPath = incPath.replace('Zigbee_ZgpSensor_Application','zigbee_device')
