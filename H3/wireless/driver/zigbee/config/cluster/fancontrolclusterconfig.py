...
fanControlClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
fanControlClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
fanControlClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
fanControlClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
...
fanControlClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/thermostat/src")
fanControlClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/thermostat/src")
fanControlClusterConfSrc.setType("SOURCE")
fanControlClusterConfSrc.setOverwrite(True)
fanControlClusterConfSrc.setMarkup(True)
...
fanControlClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
fanControlClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
fanControlClusterConfSrc.setType("SOURCE")
fanControlClusterConfSrc.setOverwrite(True)
fanControlClusterConfSrc.setMarkup(True)
