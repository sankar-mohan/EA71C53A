...
thermostatUIClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
thermostatUIClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
thermostatClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
thermostatClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
...
thermostatClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/thermostat/src")
thermostatClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/thermostat/src")
thermostatClusterConfSrc.setType("SOURCE")
thermostatClusterConfSrc.setOverwrite(True)
thermostatClusterConfSrc.setMarkup(True)
...
thermostatClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
thermostatClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
thermostatClusterConfSrc.setType("SOURCE")
thermostatClusterConfSrc.setOverwrite(True)
thermostatClusterConfSrc.setMarkup(True)
