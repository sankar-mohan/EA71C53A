...
diagnosticsClusterConf.setSourcePath("/driver/zigbee/templates/cluster/diagnostics/zclDiagnosticsCluster.h.ftl")
diagnosticsClusterConf.setOutputName("zclDiagnosticsCluster.h")
diagnosticsClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
diagnosticsClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
diagnosticsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/diagnostics/msDiagnosticsCluster.c.ftl")
diagnosticsClusterConfSrc.setOutputName("msDiagnosticsCluster.c")
diagnosticsClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/multiSensor/src")
diagnosticsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/multiSensor/src")
...
diagnosticsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/diagnostics/customDiagnosticsCluster.c.ftl")
diagnosticsClusterConfSrc.setOutputName("customDiagnosticsCluster.c")
diagnosticsClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
diagnosticsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
diagnosticsClusterConfSrc.setType("SOURCE")
diagnosticsClusterConfSrc.setOverwrite(True)
diagnosticsClusterConfSrc.setMarkup(True)
