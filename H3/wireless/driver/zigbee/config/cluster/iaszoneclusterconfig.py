...
iasZoneClusterConf.setSourcePath("/driver/zigbee/templates/cluster/iaszone/zclIasZoneCluster.h.ftl")
iasZoneClusterConf.setOutputName("zclIasZoneCluster.h")
iasZoneClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
iasZoneClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
iasZoneClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/iaszone/ciIasZoneCluster.c.ftl")
iasZoneClusterConfSrc.setOutputName("ciIasZoneCluster.c")
iasZoneClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
iasZoneClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
...
iasZoneClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/iaszone/iasACEZoneCluster.c.ftl")
iasZoneClusterConfSrc.setOutputName("iasACEZoneCluster.c")
iasZoneClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/ias_ace/src")
iasZoneClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/ias_ace/src")
iasZoneClusterConfSrc.setType("SOURCE")
iasZoneClusterConfSrc.setOverwrite(True)
iasZoneClusterConfSrc.setMarkup(True)
...
iasZoneClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/iaszone/customIasZoneCluster.c.ftl")
iasZoneClusterConfSrc.setOutputName("customIasZoneCluster.c")
iasZoneClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
iasZoneClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
iasZoneClusterConfSrc.setType("SOURCE")
iasZoneClusterConfSrc.setOverwrite(True)
iasZoneClusterConfSrc.setMarkup(True)
