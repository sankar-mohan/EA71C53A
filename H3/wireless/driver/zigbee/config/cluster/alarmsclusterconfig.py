...
alarmsClusterConf.setSourcePath("/driver/zigbee/templates/cluster/alarms/zclAlarmsCluster.h.ftl")
alarmsClusterConf.setOutputName("zclAlarmsCluster.h")
alarmsClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
alarmsClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
alarmsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/alarms/alarmsCluster.c.ftl")
alarmsClusterConfSrc.setOutputName("alarmCluster.c")
alarmsClusterConfSrc.setDestPath("/zigbee/zigbee_device/clusters/src")
alarmsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/clusters/src")
...
alarmsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/alarms/ciAlarmsCluster.c.ftl")
alarmsClusterConfSrc.setOutputName("ciAlarmsCluster.c")
alarmsClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
alarmsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
alarmsClusterConfSrc.setType("SOURCE")
alarmsClusterConfSrc.setOverwrite(True)
alarmsClusterConfSrc.setMarkup(True)
...
alarmsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/alarms/thAlarmsCluster.c.ftl")
alarmsClusterConfSrc.setOutputName("thAlarmsCluster.c")
alarmsClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/thermostat/src")
alarmsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/thermostat/src")
alarmsClusterConfSrc.setType("SOURCE")
alarmsClusterConfSrc.setOverwrite(True)
alarmsClusterConfSrc.setMarkup(True)
...
alarmsClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/alarms/customAlarmsCluster.c.ftl")
alarmsClusterConfSrc.setOutputName("customAlarmsCluster.c")
alarmsClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
alarmsClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
alarmsClusterConfSrc.setType("SOURCE")
alarmsClusterConfSrc.setOverwrite(True)
alarmsClusterConfSrc.setMarkup(True)
