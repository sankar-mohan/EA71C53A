...
timeClusterConf.setSourcePath("/driver/zigbee/templates/cluster/time/zclTimeCluster.h.ftl")
timeClusterConf.setOutputName("zclTimeCluster.h")
timeClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
timeClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
timeClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/time/ciTimeCluster.c.ftl")
timeClusterConfSrc.setOutputName("ciTimeCluster.c")
timeClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
timeClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
...
timeClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/time/thTimeCluster.c.ftl")
timeClusterConfSrc.setOutputName("thTimeCluster.c")
timeClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/thermostat/src")
timeClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/thermostat/src")
timeClusterConfSrc.setType("SOURCE")
timeClusterConfSrc.setOverwrite(True)
timeClusterConfSrc.setMarkup(True)
...
timeClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/time/customTimeCluster.c.ftl")
timeClusterConfSrc.setOutputName("customTimeCluster.c")
timeClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
timeClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
timeClusterConfSrc.setType("SOURCE")
timeClusterConfSrc.setOverwrite(True)
timeClusterConfSrc.setMarkup(True)
