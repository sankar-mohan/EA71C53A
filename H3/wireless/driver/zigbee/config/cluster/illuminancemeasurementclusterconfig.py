...
illuMeasClusterConf.setSourcePath("/driver/zigbee/templates/cluster/illuminancemeasurement/zclIlluminanceMeasurementCluster.h.ftl")
illuMeasClusterConf.setOutputName("zclIlluminanceMeasurementCluster.h")
illuMeasClusterConf.setDestPath("/zigbee/lib/include/zcl/include")
illuMeasClusterConf.setProjectPath("config/" + configName + "/zigbee/lib/include/zcl/include")
...
illuMeasClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/illuminancemeasurement/ciIlluminanceMeasurementCluster.c.ftl")
illuMeasClusterConfSrc.setOutputName("ciIlluminanceMeasurementCluster.c")
illuMeasClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/combinedInterface/src")
illuMeasClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/combinedInterface/src")
...
illuMeasClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/illuminancemeasurement/lsIlluminanceMeasurementCluster.c.ftl")
illuMeasClusterConfSrc.setOutputName("lsIlluminanceMeasurementCluster.c")
illuMeasClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/multiSensor/src")
illuMeasClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/multiSensor/src")
illuMeasClusterConfSrc.setType("SOURCE")
illuMeasClusterConfSrc.setOverwrite(True)
illuMeasClusterConfSrc.setMarkup(True)
...
illuMeasClusterConfSrc.setSourcePath("/driver/zigbee/templates/cluster/illuminancemeasurement/customIlluminanceMeasurementCluster.c.ftl")
illuMeasClusterConfSrc.setOutputName("customIlluminanceMeasurementCluster.c")
illuMeasClusterConfSrc.setDestPath("/zigbee/zigbee_device/devicetypes/custom/src")
illuMeasClusterConfSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/custom/src")
illuMeasClusterConfSrc.setType("SOURCE")
illuMeasClusterConfSrc.setOverwrite(True)
illuMeasClusterConfSrc.setMarkup(True)
