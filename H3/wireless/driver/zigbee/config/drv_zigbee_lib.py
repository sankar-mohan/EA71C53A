...
#####################################################################################################
    ...
    zigbeeDevSelectConf.setDestPath("/zigbee/zigbee_device/configs")
    zigbeeDevSelectConf.setProjectPath("config/" + configName + "/zigbee/zigbee_device/configs")
    ...
    zigbeeAppConf.setDestPath("/zigbee/zigbee_device/configs")
    zigbeeAppConf.setProjectPath("config/" + configName + "/zigbee/zigbee_device/configs")
    ...
    zigbeeBitCloudPreConf.setDestPath("/zigbee/zigbee_device/configs")
    zigbeeBitCloudPreConf.setProjectPath("config/" + configName + "/zigbee/zigbee_device/configs")
    ...
    zigbeeStackConf.setDestPath("/zigbee/zigbee_device/configs")
    zigbeeStackConf.setProjectPath("config/" + configName + "/zigbee/zigbee_device/configs")
    ...
    zigbeeAppConst.setDestPath("/zigbee/zigbee_device/common/include")
    zigbeeAppConst.setProjectPath("config/" + configName + "/zigbee/zigbee_device/common/include")
    ...
    #zigbeeOtauConf.setDestPath("/zigbee/zigbee_device/configs")
    #zigbeeOtauConf.setProjectPath("config/" + configName + "/zigbee/zigbee_device/configs")
    ...
    app_zgbSourceFile.setOverwrite(True)
    app_zgbSourceFile.setDestPath('/zigbee/zigbee_device/common/src/')
    app_zgbSourceFile.setProjectPath('config/' + configName + '/zigbee/zigbee_device/common/src/')
    app_zgbSourceFile.setType('SOURCE')
    app_zgbSourceFile.setEnabled(True)
    app_zgbSourceFile.setMarkup(True)
    ...
    app_zgbSourceFile.setOverwrite(True)
    app_zgbSourceFile.setDestPath('/zigbee/zigbee_device/common/include/')
    app_zgbSourceFile.setProjectPath('config/' + configName + '/zigbee/zigbee_device/common/include/')
    app_zgbSourceFile.setType('HEADER')
    app_zgbSourceFile.setEnabled(True)
    app_zgbSourceFile.setMarkup(True)
...
#       ['zllplatform/ZLL/D_XNv/src/D_XNv.c',                     condPDSUseExternalMem],
    ...
    applicationCommonSrcFiles = [
        #['application/zigbee_only/common_files/src/initialization.c',                                    condAlways],
         ['application/zigbee_only/common_files/src/zigbee_init.c',                                    condAlways],    
    ...
    deviceTypesSrcFiles = [
        ...
        ['application/zigbee_only/Zigbee_Device_Application/devicetypes/light/src/lightPdt.c',                                  condDevLight],
        ...
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/custom.c',                                     condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customClusters.c',                             condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customBasicCluster.c',                         condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customIdentifyCluster.c',                      condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customGroupsCluster.c',                        condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customScenesCluster.c',                        condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customOnOffCluster.c',                         condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customLevelControlCluster.c',                  condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customColorControlCluster.c',                  condDevCustom],
        ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customColorSchemesConversion.c',               condDevCustom],
        ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customCommissioningCluster.c',                 condDevCustom],
        # ['application/zigbee_only/Zigbee_Device_Application/devicetypes/custom/src/customConsole.c',                              condDevCustom],
    ]
    ...
    zigbeeLightSrc.setDestPath("/zigbee/zigbee_device/devicetypes/light/src")
    zigbeeLightSrc.setProjectPath("config/" + configName + "/zigbee/zigbee_device/devicetypes/light/src")
...
#        importConsoleSrcFileNonStack(drvZigbeeComponent, configName, srcFileEntry)
    ...
    zigbeeStackdrvIncPaths = [
        ...
        #['/src/Components/pds/include',                                        condAlways],
        #['/src/Components/ZGP',                                                condAlways],
        #['/src/Components/ZGP/include',                                        condAlways],
        #['/src/Components/ZGP/GPInfrastructure/highZgp/include',               condAlways],
        #['/src/Components/ZGP/GPInfrastructure/highZgp/include/private',       condAlways],
        #['/src/Components/ZGP/GPInfrastructure/lowZgp/include',                condAlways],
        #['/src/Components/ZGP/GPInfrastructure/lowZgp/include/private',        condAlways],
        ...
        #['/drivers/PersistDataServer',                                          condAlways],
        #['/drivers/PersistDataServer/Lib',                                          condAlways],
        #['/drivers/PersistDataServer/include',                                   condAlways],
        #['/drivers/PersistDataServer/wl/include',                                condAlways],
        #['/drivers/PersistDataServer/S_XNv/include',                             condAlways],
        #['/drivers/PersistDataServer/S_Nv/include',                              condAlways],
        #['/drivers/PersistDataServer/D_XNv/include',                             condAlways],
        #['/drivers/PersistDataServer/D_Nv/include',                              condAlways],
        #['/drivers/PersistDataServer/flash',                                     condAlways],
...
################################### Library File ####################################################
    setAdditionaloptionXC32GCC = drvZigbeeComponent.createSettingSymbol('SET_XC32_GCC_ADD_INC', None)
    setAdditionaloptionXC32GCC.setValue('-include"zigbee_device/configs/Zigbee_AllDevice_Makerules.h"')
    setAdditionaloptionXC32GCC.setCategory('C32')
    setAdditionaloptionXC32GCC.setKey('appendMe')
...
def setIncPath(component, configName, incPathEntry):
    ...
    #incPath = incPath.replace('zgb_wrappers','zigbee/zigbee_af_interface')
