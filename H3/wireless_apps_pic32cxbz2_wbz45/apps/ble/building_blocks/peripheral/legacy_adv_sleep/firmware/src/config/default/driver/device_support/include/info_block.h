...
*       returns FAILS (1)
*
*@param[out] uint8_t *  "p_Addr" is the pointer to the memory stores BDADDR
*
...
*       returns FAILS (1))
*
*@param[out] uint8_t *  "p_Addr" is the pointer to the memory stores MAC_ADDR
*
...
// *****************************************************************************
/**
*@brief This routine will get factory temperature ADC value from IB. Since the room 
*       temperature ADC value varies piece by piece, it needs to read and store in
*       IB during production. User can get room temperature ADC value from IB and
*       use it for compensations over temperature
*
*@param uint16_t *    p_factoryCalTemp is the pointer to the memory stores 
*                       factory temperature ADC value
*
*@retval A boolean value, True means valid factory temperature ADC IB
*/
bool IB_GetFactoryCalTemp(uint16_t * p_factoryCalTemp);
